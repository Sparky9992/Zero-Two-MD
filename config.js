...
global.ytname = "YT: PIYUSH KHEDE"
global.location = "India, Vadodara, Gujarat"
global.botscript = "YOU WANT REPO..?(〃ﾟ3ﾟ〃)"
...
//═══════[modification]════════\\
global.owner = process.env.owner || ['918839439805'] //owner number, u can put multiple owner number, within quotations and seperated by comma.
global.pemilik = ['918839439805'] //another owner number
global.premium = ['918839439805'] //premium number
global.pengguna = '𝐙𝐞𝐫𝐨 𝐓𝐰𝐨 𝐌𝐝' //username
global.mongodb = process.env.MONGODB || "mongodb+srv://carabot9:carabot9@cluster0.wbn9l.mongodb.net/?retryWrites=true&w=majority"
...
global.ownername = process.env.ownername || 'ISHAAN✨' //owner name
global.packname = process.env.SPACK_NAME || 'MADE BY😋❤️' //sticker package name
global.author = process.env.SPACK_AUTHOR || 'FROM ISHAAN!✨' //sticker author name
global.sessionName = process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID
global.zerotwo = "https://instagram.com/oyepiyush09" //ur gc link
global.zerotwo2 = "https://instagram.com/oyepiyush09" //ur gc link2
global.websitex = "https://instagram.com/oyepiyush09" //ur website
global.prefa = ['-'] //prefix
global.sp = '✨' //design
global.mess = {
